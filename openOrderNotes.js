    ...
    const cellRenderer = class OrderNotesCellRenderer extends BaseCellRenderer {
        init(params){
            ...
            this.childScope.$apply(() => {
                ...
                this.eGui.innerHTML = "<order-grid-notes item='row.entity' on-update='grid.appScope.__onUpdateOrderNotes' notes='grid.appScope.__ordersNotes[row.entity.OrderId]'></order-grid-notes>";
